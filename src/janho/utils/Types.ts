...
type x07 = "bool" | "double" | "ippatu"
type x08 = "wait" | "ready" | "game"
type x09 = "wait" | "ready" | "loaded" | "game" | "dead"
type x0a = "dora" | "uradora"
type x0b = "m" | "p" | "s" | "j"
type x0c = 0 | 1 | 2
type x0d = "richi" | "ippatsu" | "chankan" | "rinshan" | "haitei" | "tenho"
type x0e = "tsumibo" | "richibo"
type x0f = "debug" | "info" | "notice" | "warning" | "error" | "success"
type param = {
    "bakaze": x01, "jikaze": x01, 
    "yakuhai": {"richi": x0c, "ippatsu": boolean, "chankan": boolean, "rinshan": boolean, "haitei": x0c, "tenho": x0c}, 
    "dora": number[], "uradora": number[], 
    "kyotaku": {"tsumibo": number, "richibo": number}
}
*/