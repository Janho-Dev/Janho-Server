...
export class StartRoom implements ProtocolIF {
            ...
            if(typeof parsed["bool"] === "boolean"){
                ...
                if(roomId !== null){
                    ...
                    if(room !== null){
                        ...
                        if(result) this.procEmit(socketId, {"protocol": "startRoom", "result": true})
                        else this.procEmit(socketId, {"protocol": "startRoom", "result": false})
                    }
                }
            }
        }
